...
var lyr_AlbertaWaterbodies_2 = new ol.layer.Vector({
                ...
                interactive: false,
                title: '<img src="styles/legend/AlbertaWaterbodies_2.png" /> Alberta Waterbodies'
            });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_AlbertaBoundary_1.setVisible(true);lyr_AlbertaWaterbodies_2.setVisible(true);lyr_FishStockingPoints_3.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_AlbertaBoundary_1,lyr_AlbertaWaterbodies_2,lyr_FishStockingPoints_3];
...
lyr_AlbertaWaterbodies_2.set('fieldAliases', {'HYDROUID': 'HYDROUID', 'NAME': 'NAME', 'RANK': 'RANK', 'PRUID': 'PRUID', });
...
lyr_AlbertaWaterbodies_2.set('fieldImages', {'HYDROUID': 'TextEdit', 'NAME': 'TextEdit', 'RANK': 'Range', 'PRUID': 'TextEdit', });
lyr_FishStockingPoints_3.set('fieldImages', {'DISTRICT': 'TextEdit', 'WATERBODY': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'SPECIES': 'TextEdit', 'GENOTYPE': 'TextEdit', 'STOCKED -': 'TextEdit', 'STOCKING N': 'TextEdit', 'PLANNED ST': 'TextEdit', 'Map Author': 'TextEdit', 'S_NUMBER': 'Range', });
